...
#define LCDDATAPORT        PORTA  // Порт и пины,
#define LCDDATADDR         DDRA   // к которым подключены
#define LCDDATAPIN         PINA   // сигналы D4-D7.
#define LCD_D4             3
#define LCD_D5             4
#define LCD_D6             5
#define LCD_D7             6
...
#define LCD_STROBEDELAY_US 5    // Задержка строба  //стандартный 5us
...
#define DELAY              1	//СТАНДАРТНАЯ 1МС
